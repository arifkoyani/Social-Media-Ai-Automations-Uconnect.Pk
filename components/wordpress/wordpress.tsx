...
import { Send, Loader2, CheckCircle2, FileText, Tag, ExternalLink } from "lucide-react";
...
export default function WordPress() {
  ...
  const isReady = blogTitle.trim() !== "" && blogKeywords.trim() !== "";
  ...
  async function handleSubmit() {
    ...
    try {
      const res = await fetch(
        "https://automation.uconnect.work/webhook/235b9712-d125-4836-9ace-c682ac08bd56",
        {
          method: "POST",
      ...
      <div className="w-full max-w-lg">
        ...
        <div className="mb-8">
          <div className="inline-flex items-center gap-2 rounded-full px-4 py-1.5 mb-4" style={{ backgroundColor: "#e97d2615", border: "1px solid #e97d2640" }}>
            ...
            <span className="text-xs font-medium tracking-widest uppercase" style={{ color: "#e97d26" }}>WordPress</span>
          </div>
        ...
        <div className="rounded-2xl p-6 space-y-5" style={{ backgroundColor: "#f9f9f9", border: "1px solid #e5e5e5" }}>
          ...
          >
            ...
            {status === "idle" && (
              <>
                <Send size={15} />
                <span>Create WordPress Blog</span>
              </>
            )}
          </button>
